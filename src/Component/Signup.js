...
class Signup extends Component {
  ...
  handleSubmit = (e) => {
    ...
    const signupDetails = { username: this.state.username, Password: this.state.Password ,ConfirmPassword:this.state.ConfirmPassword};
          ...
          <div class="row">
            ...
            <div class="col-sm-4 col-lg-4 col-md-4 col-xs-4">
              <form>
                ...
                <label className="left"><b>email</b></label><br></br>
                ...
                <label className="left"><b>ConfirmPassword</b></label><br></br>
                <input className="height" type='text' name='ConfirmPassword' onChange={this.handleChange} /><br></br>
                <p>{this.state.pwrequired}</p>
              </form><br></br>
              <button className="login" onClick={this.handleSubmit}>Signup</button>
